...
// マクロ定義
//*****************************
#define EXPLOSION_ANIM_SPEED 3       // アニメーション速度
#define EXPLOSION_MAX_ANIMATION_X 7  // アニメーション数　横
#define EXPLOSION_MAX_ANIMATION_Y 1  // アニメーション数　縦
#define SIZE D3DXVECTOR3(150.0f,150.0f,0.0f) // アニメーション数　縦
#define EXPLOSION_TEXTURE_PATH "./data/Textures/explosion000.png" // テクスチャのパス

//******************************
// コンストラクタ
//******************************
CExplosion::CExplosion() :CBillboard(OBJTYPE_PARTICLE)
{
	// 変数のクリア
	m_nCntAnim = 0;
	m_nAnimX = 0;
